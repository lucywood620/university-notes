...
def start():
    koch(*initial_conditions1())
    koch(*initial_conditions2())
    koch(*initial_conditions3())

    

def initial_conditions1():
    return coordinate(550.0,280.0), coordinate(100.0,280.0), int(recursiondepth.get())
def initial_conditions2():
    return coordinate(325.0,-105.0),coordinate(550.0,280.0), int(recursiondepth.get())
def initial_conditions3():
    return coordinate(100.0,280.0), coordinate(325.0,-105.0),  int(recursiondepth.get())
